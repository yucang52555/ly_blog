...
import com.lengyan.lyblog.model.dto.Theme;
import com.lengyan.lyblog.model.enums.BlogPropertiesEnum;
import com.lengyan.lyblog.model.enums.CommonParamsEnum;
...
public class LyblogUtils {
    ...
    public static List<BackupDto> getBackUps(String dir) {
        String srcPathStr = System.getProperties().getProperty("user.home") + "/lyblog/backup/" + dir;
    ...
    public static String getRss(List<Post> posts) throws FeedException {
        ...
        if (null == LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_TITLE.getProp())) {
            channel.setTitle("");
        } else {
            channel.setTitle(LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_TITLE.getProp()));
        }
        if (null == LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp())) {
            channel.setLink("");
        } else {
            channel.setLink(LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()));
        }
        if (null == LyblogConst.OPTIONS.get(BlogPropertiesEnum.SEO_DESC.getProp())) {
            channel.setDescription("");
        } else {
            channel.setDescription(LyblogConst.OPTIONS.get(BlogPropertiesEnum.SEO_DESC.getProp()));
        }
        ...
        for (Post post : posts) {
            ...
            item.setLink(
                    LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()) + "/archives/" + post.getPostUrl());
    ...
    public static String getSiteMap(List<Post> posts) {
        ...
        String urlBody = "";
        String urlItem;
        String urlPath = LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()) + "/archives/";
        for (Post post : posts) {
