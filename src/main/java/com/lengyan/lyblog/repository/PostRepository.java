...
public interface PostRepository extends JpaRepository<Post, Long> {
     ...
     * @return List
     */
    @Query(value = "select year(post_date) as year,month(post_date) as month,count(*) as count from lyblog_post where post_status=0 and post_type='post' group by year(post_date),month(post_date) order by year desc,month desc", nativeQuery = true)
     ...
     * @return List
     */
    @Query(value = "select year(post_date) as year,count(*) as count from lyblog_post where post_status=0 and post_type='post' group by year(post_date) order by year desc", nativeQuery = true)
     ...
     * @return List
     */
    @Query(value = "select *,year(post_date) as year,month(post_date) as month from lyblog_post where post_status=0 and post_type='post' and year(post_date)=:year and month(post_date)=:month order by post_date desc", nativeQuery = true)
     ...
     * @return List
     */
    @Query(value = "select *,year(post_date) as year from lyblog_post where post_status=0 and post_type='post' and year(post_date)=:year order by post_date desc", nativeQuery = true)
     ...
     * @return Page
     */
    @Query(value = "select * from lyblog_post where post_status=0 and post_type='post' and year(post_date)=:year and month(post_date)=:month order by post_date desc", countQuery = "select count(*) from lyblog_post where post_status=0 and year(post_date)=:year and month(post_date)=:month", nativeQuery = true)
     ...
     * @return Page
     */
    @Query(value = "select * from lyblog_post where post_status = 0 and post_type='post' and post_title like '%=:keyword%' or post_content like '%=:keyword%'", nativeQuery = true)
     ...
     * @return Long
     */
    @Query(value = "select sum(post_views) from lyblog_post", nativeQuery = true)
