...
public class ThemeController extends BaseController {
    ...
    public String themes(Model model) {
        ...
        if (null != LyblogConst.THEMES) {
            model.addAttribute("themes", LyblogConst.THEMES);
        }
    ...
    public JsonResult activeTheme(@RequestParam("siteTheme") String siteTheme,
        ...
        try {
            ...
            configuration.setSharedVariable("options", LyblogConst.OPTIONS);
    ...
    public JsonResult uploadTheme(@RequestParam("file") MultipartFile file,
        ...
        try {
            if (!file.isEmpty()) {
                ...
                LyblogConst.THEMES.clear();
                LyblogConst.THEMES = LyblogUtils.getThemes();
            } else {
    ...
    public String editor(Model model) {
        List<String> tpls = LyblogUtils.getTplName(BaseController.THEME);
