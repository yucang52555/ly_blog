...
public class PostController extends BaseController {
    ...
    public JsonResult pushPost(@ModelAttribute Post post, @RequestParam("cateList") List<String> cateList, @RequestParam("tagList") String tagList, HttpSession session) {
        ...
        try {
            //提取摘要
            int postSummary = 50;
            if (StrUtil.isNotEmpty(LyblogConst.OPTIONS.get(BlogPropertiesEnum.POST_SUMMARY.getProp()))) {
                postSummary = Integer.parseInt(LyblogConst.OPTIONS.get(BlogPropertiesEnum.POST_SUMMARY.getProp()));
            }
            //文章摘要
    ...
    public JsonResult pushAllToBaidu(@RequestParam("baiduToken") String baiduToken) {
        ...
        String blogUrl = LyblogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp());
        ...
        String result = LyblogUtils.baiduPost(blogUrl, baiduToken, urls.toString());
