...
import com.lengyan.lyblog.service.AttachmentService;
...
public class AttachmentController {
    ...
    public Map<String, Object> upload(@RequestParam("file") MultipartFile file,
        ...
        if (!file.isEmpty()) {
            try {
                //用户目录
                String userPath = System.getProperties().getProperty("user.home") + "/lyblog";
                //upload的路径
                ...
                attachment.setAttachSize(LyblogUtils.parseSize(new File(mediaPath, fileName).length()));
                attachment.setAttachWh(LyblogUtils.getImageWh(new File(mediaPath, fileName)));
