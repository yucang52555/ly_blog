...
public class AdminController extends BaseController {
    ...
    public JsonResult getLogin(@ModelAttribute("loginName") String loginName,
        ...
        if (ObjectUtil.equal(aUser, user)) {
            session.setAttribute(LyblogConst.USER_SESSION_KEY, aUser);
            //重置用户的登录状态为正常
     ...
     * 不可描述的页面
     *
     * @return 模板路径admin/admin_lyblog
     */
    @GetMapping(value = "/lyblog")
    public String lyblog() {
        return "admin/admin_lyblog";
    }
