    ...
    <section class="content container-fluid animated fadeIn">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-default " type="button" onclick="lyblog.layerModal('/admin/attachments/select?id=galleryUrl','<@spring.message code="common.js.all-attachment" />')"><@spring.message code='common.btn.choose' /></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <#list galleries.content as gallery>
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 div-thumbnail" onclick="lyblog.layerModal('/admin/page/gallery?galleryId=${gallery.galleryId?c}','<@spring.message code="admin.pages.galleries.modal.title" />')">
