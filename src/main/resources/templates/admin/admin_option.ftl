                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default " type="button" onclick="lyblog.layerModal('/admin/attachments/select?id=blogLogo','<@spring.message code="common.js.all-attachment" />')"><@spring.message code='common.btn.choose' /></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default " type="button" onclick="lyblog.layerModal('/admin/attachments/select?id=blogFavicon','<@spring.message code="common.js.all-attachment" />')"><@spring.message code='common.btn.choose' /></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
        ...
        function updateAllSummary() {
            $.ajax({
                ...
                success: function (data) {
                    if(data.code==1){
                        lyblog.showMsg(data.msg,'success',1000);
                    }else{
