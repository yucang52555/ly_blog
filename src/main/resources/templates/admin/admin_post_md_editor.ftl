...
<div class="content-wrapper">
    ...
    <section class="content-header animated fadeIn">
        ...
        <a class="btn-header" id="btnOpenAttach" href="#" onclick="lyblog.layerModal('/admin/attachments/select?type=post','<@spring.message code="common.js.all-attachment" />')">
...
<#compress >
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div>
                            <#if post??>
                                <img src="${post.postThumbnail?default("/static/images/thumbnail/thumbnail.png")}" class="img-responsive img-thumbnail" id="selectImg" onclick="lyblog.layerModal('/admin/attachments/select?id=selectImg','<@spring.message code="common.js.all-attachment" />')" style="cursor: pointer;">
                            <#else >
                                <img src="/static/images/thumbnail/thumbnail.png" class="img-responsive img-thumbnail" id="selectImg" onclick="lyblog.layerModal('/admin/attachments/select?id=selectImg','<@spring.message code="common.js.all-attachment" />')" style="cursor: pointer;">
                            </#if>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function urlOnBlurAuto() {
            if($('#newPostUrl').val()===""){
                lyblog.showMsg("<@spring.message code='admin.editor.js.no-url' />",'info',2000);
                return;
            }
            $.ajax({
                type: 'GET',
                ...
                success: function (data) {
                    if(data.code==0){
                        lyblog.showMsg(data.msg,'error',2000);
                        return;
                    }else{
        ...
        function push(status) {
            ...
            if(postTitle.val()){
                ...
                lyblog.showMsg("<@spring.message code='admin.editor.js.no-title' />",'info',2000);
                return;
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.code==1){
                        ...
                        lyblog.showMsgAndRedirect(data.msg,'success',1000,'/admin/posts');
                    }else{
                        lyblog.showMsg(data.msg,'error',2000);
                    }
                }
