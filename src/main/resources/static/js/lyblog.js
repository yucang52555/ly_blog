 ...
 */
$.lyblog.prototype.showMsg = function (text, icon, hideAfter) {
 ...
 * @param hideAfter 隐藏时间
 */
$.lyblog.prototype.showMsgAndReload = function (text, icon, hideAfter) {
    if (heading == undefined) {
        var heading = "提示";
    }
    $.toast({
 ...
 * @param url 重定向地址
 */
$.lyblog.prototype.showMsgAndRedirect = function (text, icon, hideAfter, url) {
    if (heading == undefined) {
        var heading = "提示";
    }
    $.toast({
 ...
 * @param url url
 */
$.lyblog.prototype.showMsgAndParentRedirect = function (text, icon, hideAfter, url) {
    if (heading == undefined) {
        var heading = "提示";
    }
    $.toast({
 ...
 * @returns {*} a
 */
$.lyblog.prototype.formatContent = function (a) {
    a = a.replace(/\r\n/g, '<br/>');
    a = a.replace(/\n/g, '<br/>');
    a = a.replace(/\s/g, ' ');
    return a;
 ...
 * @param title 标题
 */
$.lyblog.prototype.layerModal = function (url, title) {
    layer.open({
        type: 2,
        title: title,
        shadeClose: true,
