...
<div class="content-wrapper">
    ...
    <section class="content-header animated fadeIn">
        ...
        <a class="btn-header" id="showForm" href="#" onclick="lyblog.layerModal('/admin/themes/install','<@spring.message code="admin.themes.js.install-theme" />')">
