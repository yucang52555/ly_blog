    ...
    <section class="content container-fluid animated fadeIn">
        ...
        <div class="row">
            <#list attachments.content as attachment>
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 div-thumbnail" onclick="lyblog.layerModal('/admin/attachments/attachment?attachId=${attachment.attachId?c}','<@spring.message code="admin.attachments.modal.detail-title" />')">
    ...
    <script type="application/javascript">
        function loadFileInput() {
            $('#uploadImg').fileinput({
                ...
                if(data.success=="1"){
                    $("#uploadForm").hide(400);
                    lyblog.showMsgAndReload(data.message,'success',1000);
                }
            });
        }
